 ...
 */
package main.java.Tests.Stubs.Network;
 ...
 * @author jmillen
 */
public class SocketStubBadNewLine implements ISocketChannel
{
    ...
    {
        bytesToRead = new String(new char[1]).replace("\0", "X");
        bytesToRead = bytesToRead.concat("\n");
        bytesToRead = bytesToRead.concat(new String(new char[bytes - 1]).replace("\0", "X"));
